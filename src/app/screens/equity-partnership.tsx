    ...
    <div className="min-h-screen bg-white pb-20">
      ...
      <main className="max-w-3xl mx-auto px-6 py-8">
        <div className="space-y-8">
          ...
          {/* GFX-ONBD-012: Equity Partnership Hero Illustration */}
          {/* TODO: Replace Handshake icon with growing tree illustration — see GRAPHIC_DESIGN_SPEC.md */}
          {/* <img src="/illustrations/onboarding/gfx-onbd-012-equity-hero.svg" alt="" className="w-60 h-60 mx-auto" /> */}
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-lg p-8 space-y-6">
            ...
            <button
              className="w-full bg-accent hover:bg-accent/90 text-white font-bold py-3 px-6 rounded-xl min-h-[48px] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
